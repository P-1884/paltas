#!/bin/bash -l
echo =========================================================   
echo Job submitted  date = Wed 24 Sep 14:14:29 BST 2025      
date_start=`date +%s`
...
export OMP_NUM_THEADS=1
 /usr/local/shared/slurm/bin/srun -u -n 1 --mpi=pmix --mem-per-cpu=512 nice -n 10 /mnt/zfsusers/hollowayp/paltas/./Glamdring_queue_test.sh arg1 arg2
  echo ---------------                                           
