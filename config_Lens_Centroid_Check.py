...
'theta_E':1.0,
'e1':1.0,
'e2':1.0,#norm(loc=0.0015,scale=0.1595).rvs,
'center_x':1.0,#orm(loc=0.0,scale=0.12).rvs,
'center_y':1.0,#norm(loc=0.0,scale=0.12).rvs,
'gamma1':1.0,#norm(loc=0.0,scale=0.078).rvs,
'gamma2':1.0,#norm(loc=0.0,scale=0.078).rvs,
'ra_0':0.0, 'dec_0':0.0
}
},
'lens_light':{
...
'n_sersic':4.0,
'e1':1.0,#norm(loc=0.0012,scale=0.1593).rvs,
'e2':1.0,#norm(loc=0.0015,scale=0.1595).rvs,
'center_x':1.0,#norm(loc=0.0,scale=0.12).rvs,
'center_y':1.0,#norm(loc=0.0,scale=0.12).rvs,
}
},
'source':{
