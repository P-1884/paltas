#!/bin/bash -l
echo =========================================================   
echo Job submitted  date = Fri  3 Oct 13:32:17 BST 2025      
date_start=`date +%s`
...
export OMP_NUM_THEADS=1
 /usr/local/shared/slurm/bin/srun -u -n 1 --mpi=pmix --mem-per-cpu=20480 nice -n 10 /mnt/users/hollowayp/python114_archive/bin/python3.11 save_predictions.py 40 40 _mu3_B_theta_E_-1pct diag _mu3_B_theta_E_-1pct ''
  echo ---------------                                           
