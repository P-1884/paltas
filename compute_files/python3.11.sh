#!/bin/bash -l
echo =========================================================   
echo Job submitted  date = Mon Feb  5 17:11:59 GMT 2024      
date_start=`date +%s`
...
export OMP_NUM_THREADS=4
 nice -n 10 /mnt/users/hollowayp/python11_env/bin/python3.11 /mnt/users/hollowayp/paltas/paltas/Analysis/train_model.py /mnt/users/hollowayp/paltas/paltas/Analysis/AnalysisConfigs/train_config_Lenspop.py --h5
