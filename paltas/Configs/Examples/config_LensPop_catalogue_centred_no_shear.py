...
RSP_cutout_folder='/mnt/extraspace/hollowayp/paltas_data/Coadd_files_testset/'
...
save_noise=False
Catalogue_directory = '/mnt/zfsusers/hollowayp/paltas/datasets/LensPop_databases/LensPop_LSST_Paltas_Catalogue_0_centred_no_shear.csv'
config_dict = {
	'main_deflector':{
		'class': PEMDShear,
