...
root_path = '/users/holloway/Documents/paltas/'
cosmos_folder = '/users/holloway/localscratch/Euclid_Lens_Modelling_Project/COSMOS_23.5_training_sample'
...
'detector':{
'parameters':{
'pixel_scale':0.1,'ccd_gain':20,'read_noise':100,
'magnitude_zero_point':output_ab_zeropoint,
'exposure_time':1,'sky_brightness':50, #Image flux is per second. It doesn't scale with exposure time.
