...
'parameters':{
'M200': 1e13,
'z_lens':truncnorm(-1.2123,np.inf,loc=0.42,scale=0.3464).rvs,
'gamma':truncnorm(-3.0303,np.inf,loc=2.0,scale=0.33).rvs,
'theta_E':truncnorm(-2.6638,np.inf,loc=1.5157,scale=0.569).rvs,
'e1':norm(loc=0.0012,scale=0.1991).rvs,
'e2':norm(loc=0.0015,scale=0.1994).rvs,
...
'parameters':{
'z_source':truncnorm(-1.2123,np.inf,loc=0.42,scale=0.3464).rvs,
'mag_app':norm(loc=17.6226,scale=2.6232).rvs,
'output_ab_zeropoint':output_ab_zeropoint,
'R_sersic':truncnorm(-1.1704,np.inf,loc=1.0818,scale=0.9243).rvs,
'n_sersic':4.0,
'e1':norm(loc=0.0012,scale=0.1991).rvs,
'e2':norm(loc=0.0015,scale=0.1994).rvs,
'center_x':norm(loc=0.0,scale=0.15).rvs,
...
'class': SingleSersicSource,
'parameters':{
'z_source':truncnorm(-1.3634,np.inf,loc=1.8224,scale=1.3367).rvs,
'mag_app':norm(loc=24.4371,scale=1.5614).rvs,
'output_ab_zeropoint':output_ab_zeropoint,
'R_sersic':truncnorm(-1.1373,np.inf,loc=0.3951,scale=0.3474).rvs,
'n_sersic':1.0,
'e1':norm(loc=-0.0016,scale=0.2836).rvs,
'e2':norm(loc=-0.0004,scale=0.2838).rvs,
'center_x':norm(loc=-0.0021,scale=0.5975).rvs,
'center_y':norm(loc=-0.0032,scale=0.7341).rvs,
}
},
'cosmology':{
'parameters':{
...
z_lens_min=0,z_lens_mean=0.42,z_lens_std=0.3464,
z_source_min=0,z_source_mean=1.8224,z_source_std=1.3367)
}
}
}
