...
class args_class:
	def __init__(self,args):
		...
		self.n = args['n']
		self.save_png_too = args['save_png_too']
		self.tf_record = args['tf_record']
		self.h5 = args['h5']
		self.config_module = args['config_module']
...
def main(args_dict=None):
	...
	if args_dict is None: args = parse_args();print('parsing args')
	else: args = args_class(args_dict)
	# print('args',args)
	...
	# print('module',args_dict['config_module'])
	if args_dict is None: config_handler = ConfigHandler(args.config_dict)
	else: config_handler = ConfigHandler(args_dict['config_module'].blank_config)
	# Generate our images
