...
directory_to_save_model = f'/mnt/extraspace/hollowayp/paltas_data/Example_LP_{model_folder_number}_no_RSP_mu3/' #Glamdring
directory_for_training_images =  f'/mnt/extraspace/hollowayp/paltas_data/Example_LP_{folder_number}_no_RSP_mu3/'
directory_for_validation_images =  f'/mnt/extraspace/hollowayp/paltas_data/Example_LP_{folder_number}_no_RSP_mu3/'
