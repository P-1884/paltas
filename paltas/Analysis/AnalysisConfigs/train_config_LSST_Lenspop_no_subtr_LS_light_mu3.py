...
learning_params += ['source_parameters_R_sersic','lens_light_parameters_R_sersic',
	'source_parameters_center_x','source_parameters_center_y',
]
log_learning_params = ['lens_light_parameters_mag_app','source_parameters_mag_app']
...
folder_number = 40
model_folder_number = 40
directory_to_save_model = f'/mnt/extraspace/hollowayp/paltas_data/Example_LP_{model_folder_number}_no_subtr_LS_light_mu3/' #Glamdring
directory_for_training_images =  f'/mnt/extraspace/hollowayp/paltas_data/Example_LP_{folder_number}_no_subtr_LS_light_mu3/'
directory_for_validation_images =  f'/mnt/extraspace/hollowayp/paltas_data/Example_LP_{folder_number}_no_subtr_LS_light_mu3/'
