...
directory_to_save_model = '/mnt/extraspace/hollowayp/paltas_data/covariance_test/paltas_covariance_test_500k_nocov/diag_cov_12/' #Glamdring
directory_for_training_images =  '/mnt/extraspace/hollowayp/paltas_data/covariance_test/paltas_covariance_test_500k_nocov/'
directory_for_validation_images =  '/mnt/extraspace/hollowayp/paltas_data/covariance_test/paltas_covariance_test_500k_nocov/'
...
npy_folder_val = (directory_for_validation_images+'validation/0/') #Assumes there is only one validation folder.
