...
folder_number = 32
model_folder_number = 33
directory_to_save_model = f'/mnt/extraspace/hollowayp/paltas_data/Example_LP_{model_folder_number}_centred_no_shear/' #Glamdring
directory_for_training_images =  f'/mnt/extraspace/hollowayp/paltas_data/Example_LP_{folder_number}_centred_no_shear/'
directory_for_validation_images =  f'/mnt/extraspace/hollowayp/paltas_data/Example_LP_{folder_number}_centred_no_shear/'
