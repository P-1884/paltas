...
directory_to_save_model = '/mnt/extraspace/hollowayp/paltas_data/Example_K/'
directory_for_training_images =  '/mnt/extraspace/hollowayp/paltas_data/Example_K/'
directory_for_validation_images =  '/mnt/extraspace/hollowayp/paltas_data/Example_K/'
...
try:
    ...
    print(f'No folder found for training images: using {directory_for_training_images}/norms.csv as the norm-path instead')
    input_norm_path = directory_for_training_images + '/norms.csv'
