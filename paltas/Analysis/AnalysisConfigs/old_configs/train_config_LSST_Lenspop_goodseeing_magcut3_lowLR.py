...
folder_number = 18
directory_to_save_model = f'/mnt/extraspace/hollowayp/paltas_data/Example_LP_{folder_number}_goodseeing_magcut3_lowLR/' #Glamdring
directory_for_training_images =  f'/mnt/extraspace/hollowayp/paltas_data/Example_LP_{folder_number}_goodseeing_magcut3/'
directory_for_validation_images = f'/mnt/extraspace/hollowayp/paltas_data/Example_LP_{folder_number}_goodseeing_magcut3/'
