...
folder_number = 19
directory_to_save_model = f'/mnt/extraspace/hollowayp/paltas_data/Example_LP_{folder_number}_no_subtr_LS_light_4/' #Glamdring
directory_for_training_images =  f'/mnt/extraspace/hollowayp/paltas_data/Example_LP_{folder_number}_no_subtr/'
directory_for_validation_images =  f'/mnt/extraspace/hollowayp/paltas_data/Example_LP_{folder_number}_no_subtr/'
