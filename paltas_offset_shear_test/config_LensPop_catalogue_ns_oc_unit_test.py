...
save_noise=False
Catalogue_directory = '/mnt/zfsusers/hollowayp/paltas/datasets/LensPop_databases/LensPop_LSST_Paltas_Catalogue_0_noshear_offcentred_unit_test.csv'
config_dict = {
	'main_deflector':{
		'class': PEMDShear,
...
'file': None,
'parameters':{
'pixel_scale':0.1,'ccd_gain':1,'read_noise':0, #Noise is added from RSP. Gain from here https://community.lsst.org/t/dp0-zeropoints-adding-poisson-noise/8230/7, correct for DP0
'magnitude_zero_point':output_ab_zeropoint,
'exposure_time':30,'sky_brightness':100,
'num_exposures':1000,'background_noise':None  #Number of exposures matching the DP0 coadds.
}
},
