#!/bin/bash -l
echo =========================================================   
echo Job submitted  date = Mon Aug 21 01:27:50 BST 2023      
date_start=`date +%s`
...
export OMP_NUM_THREADS=4
 nice -n 10 /usr/bin/python3 ./paltas/Analysis/train_model.py ./paltas/Analysis/AnalysisConfigs/train_config_examp.py --h5
