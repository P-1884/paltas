#!/bin/bash -l
echo =========================================================   
echo Job submitted  date = Mon Feb 12 19:12:06 GMT 2024      
date_start=`date +%s`
...
export OMP_NUM_THEADS=1
 /usr/local/shared/slurm/bin/srun -u -n 1 --mpi=pmi2 --mem-per-cpu=512 nice -n 10 /mnt/users/hollowayp/python11_env/bin/python3.11 ./paltas/generate.py ./paltas/Configs/Examples/config_LSST_Lenspop.py ./ --n 50
