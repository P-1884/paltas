...
training_directory = f'/mnt/extraspace/hollowayp/paltas_data/Example_LP_{folder_number}_no_subtr/' #For Glamdring (in extraspace)
training_config_directory = f'{analysis_folder}.train_config_LSST_Lenspop_no_subtr_LS_light'#_no_subtr' #Keep Updated!
test_directory = f'/mnt/extraspace/hollowayp/paltas_data/Example_LP_{folder_number}_no_subtr/'
model_directory = f'/mnt/extraspace/hollowayp/paltas_data/Example_LP_{folder_number}_no_subtr_LS_light/'
