...
training_directory = f'/mnt/extraspace/hollowayp/paltas_data/Example_LP_{folder_number}/' #For Glamdring (in extraspace)
training_config_directory = f'{analysis_folder}.train_config_LSST_Lenspop'#_no_subtr' #Keep Updated!
test_directory = f'/mnt/extraspace/hollowayp/paltas_data/Example_LP_{folder_number}/'
model_directory = f'/mnt/extraspace/hollowayp/paltas_data/Example_LP_{folder_number}/'
