#!/bin/bash -l
echo =========================================================   
echo Job submitted  date = Thu 30 May 21:35:24 BST 2024      
date_start=`date +%s`
...
export OMP_NUM_THEADS=1
 /usr/local/shared/slurm/bin/srun -u -n 1 --mpi=pmix_v4 --mem-per-cpu=20480 nice -n 10 /mnt/users/hollowayp/python11_env_new/bin/python3.11 save_predictions.py 23 '' _fullcov test
  echo ---------------                                           
